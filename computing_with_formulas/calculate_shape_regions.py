...
print(f'The area of a parallelogram of height {height} and base {base} cm is \
{parallelogram_area:3.2f} cm^2')
...
print(f'The volume of a cone of radius {radius} cm and height {height} cm is \
{cone_volume:3.2f} cm^3')