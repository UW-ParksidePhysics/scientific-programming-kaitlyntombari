...
def plot_data_with_fit(data: np.ndarray, fit_curve: np.ndarray, data_format: \
str = 'x', fit_format: str = '-') -> list:
    """Function used to create a combined scatter and curve plot for the data and \
    the fit polynomial."""
    data_plot = plt.scatter(data[0], data[1], data_format)
...
if __name__ == "__main__":
    ...
    combined_plot = plot_data_with_fit(data, fit_curve, data_format = 'x', \
    fit_format = '--')
